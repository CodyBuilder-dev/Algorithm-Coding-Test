...
class PassWord :
    ...
    def left(self) :
        if len(self.passWord) > 0 :
            # self.temp.insert(0,self.passWord[-1])
            # self.passWord.pop()
            self.temp.appendleft(self.passWord.pop())
    
    def right(self) :
        if len(self.temp) > 0 :
            # self.passWord.append(self.temp[0])
            # self.temp.pop(0)
            self.passWord.append(self.temp.popleft())
    ...
    def findPassWord(self) :
        ...
        print(''.join(self.passWord + self.temp))
